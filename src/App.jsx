...
const PILLARS = [
  ...
  {
    id: 'oral',
    label: 'Oral Proficiency & Fluency',
    labelZh: '口语&流利度',
    color: B.green,
    lightColor: B.greenLight,
    skills: [
  ...
  literacy: [
    {
      name: 'Main Idea',
      nameZh: '核心大意',
      desc: '引导孩子从故事中提取关键信息，学会用一句话概括发生了什么。这是建立逻辑思考的第一步，帮助孩子在阅读初期理清叙事主线。',
    },
    {
      name: 'Punctuation Pauses',
      nameZh: '标点停顿',
      desc: '通过识别句号和逗号，教会孩子在阅读时进行自然的节奏调节，培养语感。这不仅能提高朗读流利度，更有助于孩子理解句子的结构边界。',
    },
    {
      name: "Readers' Theater",
      nameZh: '读者剧场',
      desc: '通过角色扮演和趣味朗诵，让孩子在情境中练习表达，增强阅读的趣味性。这种互动方式能有效提升孩子的口语自信心和对文本的情感理解。',
    },
  ],
  oral: [
    {
      name: 'Expressing Basic Needs',
      nameZh: '基础需求表达',
      desc: '引导孩子学会用清晰的短语或简单句表达学校生活中的基本需求。这是建立安全感和融入集体生活的关键第一步。',
    },
    {
      name: 'Phonemic Awareness & Rhythm',
      nameZh: '语音意识与节奏',
      desc: '通过儿歌、韵律诗和单词拆解，训练孩子对英语独特节奏和发音位置的感知。这能有效预防早期发音习惯偏差。',
    },
    {
      name: 'Basic Social Interaction',
      nameZh: '初级社交礼仪',
      desc: '教授基础的问候、感谢及简单的排队或分享用语。孩子将学习在社交场合中如何开启一段简单的对话。',
    },
  ],
  writing: [
    {
      ...
      nameZh: '句式起步',
      desc: "引导孩子跳出重复的'I see...'模式，尝试使用不同的词汇开启句子。通过练习多种句式开头，孩子能学会如何构建完整且有节奏感的简单句。",
    },
    {
      name: 'Punctuation Boundaries',
      nameZh: '标点边界',
      desc: "明确句号、问号和感叹号作为'思想边界'的作用，防止出现无休止的长难句。教会孩子根据语气选择正确的标点。",
    },
    {
      name: 'Personal Narratives',
      nameZh: '简单记叙',
      desc: '鼓励孩子用文字记录生活中的小瞬间，学习按时间顺序组织简单的故事情节。我们重点培养孩子捕捉细节的能力。',
    },
  ],
};
const BAND_34 = {
  literacy: [
    {
      ...
      nameZh: '比较与对比',
      desc: '教会孩子识别事物或故事间的异同点，培养分类与分析思维。通过这种方式，孩子能更深入地理解文本细节。',
    },
    {
      name: 'Visualization',
      nameZh: '视觉化想象',
      desc: "引导孩子将文字描述转化为脑海中的画面，增强对文学作品的感悟力。这种'脑内建模'的能力是提升深度阅读兴趣的关键。",
    },
    {
      name: 'Synonyms & Antonyms',
      nameZh: '同义词与反义词',
      desc: '通过学习近义词和反义词，扩充词汇库并精准掌握表达的细微差别。这能让孩子的语言描述变得生动、丰富。',
    },
  ],
  oral: [
    {
      name: 'Descriptive Storytelling',
      nameZh: '生动记叙',
      desc: '鼓励学生按照逻辑顺序描述一件趣事或讲述一个简单的故事。通过加入细节描写，学生能学会如何吸引听众的注意力。',
    },
    {
      name: 'Conversational Turn-taking',
      nameZh: '对话往返技巧',
      desc: '训练学生在对话中不仅要表达自己，更要学会倾听并根据对方的内容给出合理回应。掌握交替发言的节奏能让沟通变得更加自然。',
    },
    {
      name: 'Questioning Strategies',
      nameZh: '提问与求证',
      desc: '引导学生学会有目的地提出问题，以获取更多信息或澄清疑惑。这种主动探究的能力在课堂讨论中至关重要。',
    },
  ],
  writing: [
    {
      ...
      nameZh: '段落核心',
      desc: '教授如何撰写强有力的主题句，以此统领全段的中心思想。学生将学会围绕一个核心点展开论述。',
    },
    {
      name: 'Sensory Details',
      nameZh: '感官描写',
      desc: "引导学生在描写中加入视觉、听觉、触觉等感官细节，让文字'动'起来。通过使用精准的形容词和动词来丰富表达。",
    },
    {
      name: 'Sentence Variety',
      nameZh: '句子多样性',
      desc: '练习将短句合并或拆分，尝试使用连词构建长短结合的错落感。避免单一重复的句式，提升写作档次。',
    },
  ],
};
const BAND_56 = {
  literacy: [
    {
      ...
      nameZh: '事实与观点',
      desc: '帮助孩子区分客观事实与主观感受，这是培养批判性思维的基石。在信息爆炸时代，这种能力能教会孩子审慎地分析所读到的内容。',
    },
    {
      name: 'Summarizing',
      nameZh: '提炼摘要',
      desc: '训练孩子剔除冗余信息，精准捕捉文章的逻辑架构和核心论点。这不仅是一项重要的读写技能，更是高效学习的必备工具。',
    },
    {
      name: "Author's Purpose",
      nameZh: '作者意图',
      desc: '引导孩子思考作者的写作动机，是为了说服、告知还是娱乐。理解动机能帮助孩子更全面地把握文本语境和深层含义。',
    },
  ],
  oral: [
    {
      name: 'Informative Presentations',
      nameZh: '信息类陈述',
      desc: '训练学生就特定主题进行短时间的口头报告，学习如何组织论点并辅以事实支撑。这是为中学阶段频繁的课堂演讲做准备。',
    },
    {
      name: 'Collaborative Discussion',
      nameZh: '协作讨论',
      desc: '在小组活动中练习如何有礼貌地提出不同意见或补充他人观点。学生将学会使用转折词和连接词来维持讨论的深度。',
    },
    {
      name: 'Paraphrasing Skills',
      nameZh: '换词重组',
      desc: '教授如何用自己的语言复述听到的复杂信息。这项技能能证明学生真正理解了内容，而非机械模仿。',
    },
  ],
  writing: [
    {
      ...
      nameZh: '逻辑过渡',
      desc: '系统学习使用过渡词（如 however, therefore），建立段落间的丝滑链接。学生将学会如何引导读者在不同观点间穿梭。',
    },
    {
      name: 'Persuasive Techniques',
      nameZh: '说服技巧',
      desc: '介绍如何使用证据和理由来支持自己的立场，初步接触说服性写作。学生将学习如何识别受众并选择最具说服力的论点。',
    },
    {
      name: 'Grammar Consistency',
      nameZh: '语法严谨性',
      desc: "重点解决时态混用和主谓一致性问题，确保长篇写作中的语法稳定性。我们引导学生养成'自我审查'的习惯。",
    },
  ],
};
const BAND_78 = {
  literacy: [
    {
      name: 'Writing Style',
      nameZh: '写作风格',
      desc: "探讨不同作者如何通过选词、句式和语气来展现独特的'笔触'。通过分析他人的风格，学生能逐渐建立属于自己的写作个性。",
    },
    {
      name: 'Drawing Inferences',
      nameZh: '推断与延伸',
      desc: "教会学生阅读'字里行间'的隐藏信息，根据已知线索推导逻辑结论。这种高阶阅读技能是解析复杂文本的核心。",
    },
    {
      name: 'Identifying Theme',
      nameZh: '识别主题',
      desc: '引导学生超越具体情节，探讨文章背后的普遍真理或社会价值。理解主题能让学生将阅读内容与现实世界联系起来。',
    },
  ],
  oral: [
    {
      ...
      nameZh: '说服性演讲',
      desc: '通过练习辩论和演讲，学习如何利用逻辑、情感和事实来影响听众的立场。学生将学会构建严密的论证结构。',
    },
    {
      name: 'Register & Context',
      nameZh: '语境与语域切换',
      desc: '探讨在正式学术场合与非正式朋友聚会中，语言风格应如何灵活切换。学生将学会控制语气和选词的严谨度。',
    },
    {
      name: 'Idiomatic Usage',
      nameZh: '地道表达与成语',
      desc: "引入高频的文化成语和地道词组，让学生的表达听起来更像母语者。这能消除'教科书式英语'带来的隔阂感。",
    },
  ],
  writing: [
    {
      ...
      nameZh: '论文论点',
      desc: '训练学生在文章开头提出一个清晰、可争辩且有力度的核心论点。这是中学论文写作的灵魂。',
    },
    {
      name: 'Voice & Tone',
      nameZh: '写作语调与语境',
      desc: "探讨如何根据正式与非正式语境调整写作的'声音'，识别学术语气与创意语气的区别。",
    },
    {
      name: 'Complex Structures',
      nameZh: '复杂句式',
      desc: '鼓励使用从句和非谓语动词，将深层次的因果或对比关系融入一个句子中。使表达更加精准且具逻辑张力。',
    },
  ],
};
const BAND_910 = {
  literacy: [
    {
      ...
      nameZh: '修辞分析',
      desc: '深入探讨作者如何运用修辞手段来增强说服力并引发读者共鸣。学生将学会解析语言背后的策略。',
    },
    {
      name: 'Synthesis of Perspectives',
      nameZh: '观点综合',
      desc: '训练学生整合多篇文献的观点，并在不同声音之间寻找逻辑关联。这是撰写学术论文必备的跨文本综合分析能力。',
    },
    {
      name: 'Nuance & Subtext',
      nameZh: '语境细微差别',
      desc: '引导学生识别讽刺、隐喻以及文化语境带来的语义变化。掌握这种敏锐度能让学生在应对高难度阅读任务时游刃有余。',
    },
  ],
  oral: [
    {
      ...
      nameZh: '苏格拉底式研讨',
      desc: '训练学生在复杂的学术研讨中进行即兴输出，能够根据多方观点实时调整自己的论据。',
    },
    {
      name: 'Rhetorical Strategies',
      nameZh: '演讲修辞策略',
      desc: '引导学生在发言中有意识地运用排比、比喻和情感呼吁来增强感染力。',
    },
    {
      name: 'Synthesizing Oral Evidence',
      nameZh: '多重观点综合',
      desc: '挑战学生在口头表达中同时引用并分析多个来源的信息，构建复杂的论证体系。',
    },
  ],
  writing: [
    {
      name: 'Argumentative Logic',
      nameZh: '论证逻辑',
      desc: '深入学习如何构建严密的论证链条，包括反驳对立观点的技巧。学生将学会用逻辑而非情绪来支撑立场。',
    },
    {
      name: 'Stylistic Devices',
      nameZh: '修辞手法应用',
      desc: '引导学生在写作中有意识地运用排比、隐喻、借代等修辞手段来增强文章的艺术感染力。',
    },
    {
      name: 'Citations & Integrity',
      nameZh: '学术诚信与引用',
      desc: '教授正确的引用格式（如 MLA/APA），强调学术诚信的重要性。这是进入高中高年级必须掌握的准则。',
    },
  ],
};
const BAND_1112 = {
  literacy: [
    {
      ...
      nameZh: '文学批评与理论',
      desc: '引导学生从历史、社会或心理学等不同理论维度来审视文学作品。这是迈入大学学术殿堂的敲门砖。',
    },
    {
      name: 'Logical Fallacies',
      nameZh: '逻辑谬误',
      desc: '教会学生识别论证中的逻辑陷阱，培养严谨的理性思维和批判眼光。',
    },
    {
      name: 'Abstract Synthesis',
      nameZh: '抽象综合',
      desc: '专注于长篇学术论文的逻辑架构，培养学生处理复杂数据和抽象理论的能力。',
    },
  ],
  oral: [
    {
      ...
      nameZh: '学术辩护',
      desc: '训练学生就自己的研究成果或观点进行严谨的辩护，应对质疑并清晰阐述逻辑。',
    },
    {
      name: 'Professional Interviewing',
      nameZh: '专业面试',
      desc: '模拟大学录取或职场面试场景，练习如何精准展现个人优势并进行高效沟通。',
    },
    {
      name: 'Nuance & Intonation',
      nameZh: '语调微调',
      desc: '专注于发音细节的打磨，包括重音位置、语调起伏以及微妙的文化含义传递。',
    },
  ],
  writing: [
    {
      name: 'The Scholarly Voice',
      nameZh: '学术笔触',
      desc: '培养客观、严谨、具有权威感的学术写作风格，适应长篇论文的要求。',
    },
    {
      name: 'Structural Fluidity',
      nameZh: '结构艺术',
      desc: "突破传统的'五段式'模版，根据论点的复杂程度灵活设计文章架构。",
    },
    {
      name: 'Abstract Synthesis',
      nameZh: '抽象表达',
      desc: '挑战处理高度抽象的概念，并将其转化为逻辑清晰、证据详实的专业报告。',
    },
  ],
};
const GRADE_MODULES = {
...
const CURRICULUM = [
  {
    ...
    lightColor: B.brownLight,
    match:
      '我们通过系统化的教学培养孩子的"认知自动化"，旨在将大脑从繁重的辨词任务中解放，从而释放更多精力用于高阶逻辑分析。数据表明，保持高频互动的学生通常能在6个月内实现一至两个年级的阅读水平突破，成功跨越从"学习阅读"到"通过阅读来学习"的关键转折点',
    modules: [
      {
        name: 'Phonics Sprint',
        nameZh: '拼读冲刺',
        desc: '针对性自然拼读训练，结合可解码文本，专门解决学习者最常遇到的发音难题。',
      },
      {
        name: 'Reading Circles',
        nameZh: '阅读小组',
        desc: '小组引导阅读课，运用预测、提问、联系等阅读理解策略，深化文本理解。',
      },
      {
        name: 'Word Wealth',
        nameZh: '词汇积累',
        desc: '通过阅读、游戏和词汇图谱，系统性地扩充学生的词汇量。',
      },
    ],
  },
  {
    pillar: 'Oral Proficiency & Fluency',
    pillarZh: '口语&流利度',
    color: B.green,
    lightColor: B.greenLight,
    match:
      '我们坚信语言是鲜活的工具，而非枯燥的学科。每一堂课都经过精密设计，旨在最大化学生的"有效口语输出时间"，使学生从机械记忆转向真正的"沟通胜任力"。通过融入一对一朗读、辩论和叙事构建，我们成功架起了课堂理论与北美社交及学术环境所需的动态语言技能之间的桥梁。',
    modules: [
      {
        name: 'Talk Time',
        nameZh: '口语时间',
        desc: '围绕学生感兴趣的真实生活场景设计的每周口语挑战活动。',
      },
      {
        name: 'Pronunciation Lab',
        nameZh: '发音实验室',
        desc: '针对高频发音错误进行专项训练，结合音频示范和即时反馈。',
      },
      {
        name: 'Listen Up',
        nameZh: '专注聆听',
        desc: '精选音视频任务，训练学生对不同口音和语速的听力理解能力。',
      },
    ],
  },
  {
    pillar: 'Writing & Composition',
    pillarZh: '构思&写作',
    color: B.brownDark,
    lightColor: '#ede0d8',
    match:
      'DODO Learning是一个相信写作能力能够改变孩子未来的教育品牌。我们将写作视为学生独立思考的终极体现。我们的课程旨在引导学生从"机械造句者"蜕变为拥有独特且自信笔触的"创作者"。通过运用范文教学、图形组织工具以及专业的写作实验室模式，我们确保其书面作品能够体现出在英语教育体系中脱颖而出所需的结构化逻辑与创意表达。',
    modules: [
      {
        name: 'Sentence Gym',
        nameZh: '句子训练营',
        desc: '针对语法、标点和句型多样性的日常句子练习，夯实写作基础。',
      },
      {
        name: 'Write Like a Writer',
        nameZh: '像作家一样写作',
        desc: '以真实作家为灵感的写作项目，学生以不同体裁和风格完成创意写作。',
      },
      {
        name: 'Edit & Elevate',
        nameZh: '修改与提升',
        desc: '同伴与评估师共同参与的审阅循环，教会学生自信地修改和完善自己的作品。',
      },
    ],
  },
];
...
const F =
  '"Noto Sans SC", "Avenir Next", "Avenir", "Helvetica Neue", sans-serif';
const PW = 794; // A4 at ~96dpi
const PAD = 32;

function ReportHeader({ info, logo }) {
  return (
    <div
      style={{
        background: B.cream,
        padding: `${PAD}px ${PAD}px 16px`,
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        <div
          style={{
            borderLeft: logo ? `1.5px solid rgba(122,81,69,0.25)` : 'none',
            paddingLeft: logo ? 16 : 0,
          }}
        >
          <div
            style={{
...
function ReportPage1({ info, ratings, comments, logo }) {
  ...
  return (
    <div
      id="pdf-page1"
      style={{ width: PW, background: B.cream, fontFamily: F, color: B.ink }}
    >
      <ReportHeader info={info} logo={logo} />
      <div style={{ padding: `16px ${PAD}px ${PAD}px` }}>
        ...
        >
          ...
          >
            {[
              ['Student Name 学生姓名', info.name],
              ['Age 年龄', info.age],
              ['Grade / Year 年级', info.grade],
              ['Evaluator 评估师', info.evaluator],
              ['Assessment Phase 评估阶段', info.phase],
              ['Date 评估日期', info.date],
            ].map(([lbl, val]) => (
              <div key={lbl}>
                <div
            ...
            >
              {[
                ...
                <div key={en} style={{ padding: '5px 10px' }}>
                  ...
                  <div style={{ fontSize: 9, color: B.muted, marginTop: 1 }}>
                    {zh}
                  </div>
                </div>
              ))}
        ...
        >
          <div style={{ fontSize: 11 }}>
            {ratedCount} of {allSkills.length} skills rated · 已评估{' '}
            {ratedCount}/{allSkills.length} 项
          </div>
        </div>
      </div>
    </div>
...
function ReportPage2({
  ...
  const selectedGradeObj = GRADE_LEXILE.find(
    (g) => g.grade === proficientGrade
  );
  return (
    <div
      id="pdf-page2"
    ...
    >
      ...
      <div style={{ padding: `16px ${PAD}px ${PAD}px` }}>
        <div style={{ textAlign: 'center', marginBottom: 14 }}>
          ...
          >
            「<span style={{ color: B.green }}>{info.name || '学生'}</span>
            」的个人化英语需求
          </div>
          <div
            style={{
          ...
          >
            第一页的每一项评估结果，都直接对应DODO
            Learning的具体课程模块。以下将详细说明我们为您的孩子推荐的学习方向及长期的益处。
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Proficient Lexile Level
            </div>
            <div style={{ fontSize: 16, fontWeight: 800, color: B.green }}>
              {selectedGradeObj ? `Lexile ${selectedGradeObj.lexile}` : '—'}
            </div>
            {selectedGradeObj && (
              <div
                style={{
          ...
          >
            ...
            >
              Student Lexile Level
            </div>
            <div style={{ fontSize: 16, fontWeight: 800, color: B.brown }}>
              {studentLexile || '—'}
            </div>
            <div
              style={{
        ...
        >
          {PILLARS.map((pillar) => {
            const scored = pillar.skills.filter(
              (s) => ratings[s.id] != null && ratings[s.id] > 0
            );
            const avg =
              scored.length > 0
                ? scored.reduce((a, s) => a + ratings[s.id], 0) / scored.length
                : 0;
            const rounded = scored.length > 0 ? Math.round(avg) : null;
            const rc = rounded
              ? RATING_COLORS[rounded]
              : { bg: '#f0ece8', text: B.muted };
            return (
              <div
                key={pillar.id}
                style={{
              ...
              >
                ...
                >
                  ...
                  {rounded ? (
                    ...
                    <div style={{ color: B.border, fontSize: 12 }}>
                      暂未评估
                    </div>
                  )}
                </div>
            ...
            <div style={{ padding: '8px 14px' }}>
              ...
              >
                ...
                GRADE_MODULES[proficientGrade]?.[PILLAR_GRADE_KEY[item.pillar]]
                  ?.length
                  ? GRADE_MODULES[proficientGrade][
                      PILLAR_GRADE_KEY[item.pillar]
                    ]
                  : item.modules
                ).map((mod) => (
                  <div
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 9, color: B.ink, lineHeight: 1.55 }}
                    >
                      {mod.desc}
                    </div>
                  </div>
        ...
        {notes && (
          ...
          >
            <div style={{ marginBottom: 8 }}>
              <span style={{ fontSize: 13, fontWeight: 700, color: B.brown }}>
                Evaluator's Notes{' '}
              </span>
...
export default function DodoEvalPDF() {
  ...
  // Load external scripts + font
  useEffect(() => {
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href =
      'https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@400;500;700;800&display=swap';
    ...
    Promise.all([
      ...
      .catch(() =>
        setStatus('Failed to load PDF libraries. Check your connection.')
      );
  }, []);
  ...
  const setRating = useCallback((skillId, val) => {
    ...
    if (COMMENT_POOL[skillId]?.[n])
      setComments((c) => ({ ...c, [skillId]: COMMENT_POOL[skillId][n] }));
  }, []);
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const fileName = `DodoEval_${(info.name || 'Student').replace(
        /\s+/g,
        '_'
      )}_${info.date}.pdf`;
      pdf.save(fileName);
  ...
  return (
    <div
      style={{
        fontFamily: '"Noto Sans SC", "Avenir Next", sans-serif',
        minHeight: '100vh',
        background: '#f0ece8',
      }}
    >
      {/* ════ FORM UI ════ */}
      <div
        style={{ maxWidth: 900, margin: '0 auto', padding: '24px 20px 80px' }}
      >
        {/* Header */}
        <div
          style={{
        ...
        >
          {logo && <img src={logo} alt="" style={{ height: 40 }} />}
          <div>
            <div
              style={{
                fontSize: 11,
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: B.brown }}>
          ...
          >
            ...
            <label style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <select
                value={info.phase}
                onChange={(e) =>
                  setInfo((i) => ({ ...i, phase: e.target.value }))
                }
            ...
            <label style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <input
                ...
                value={info.date}
                onChange={(e) =>
                  setInfo((i) => ({ ...i, date: e.target.value }))
                }
                style={inp}
              />
            </label>
                  ...
                  >
                      ...
                      >
                        <select
                          ...
                          style={{
                            ...
                            fontWeight: 700,
                            cursor: 'pointer',
                            background: rc ? rc.bg : B.white,
                            color: rc ? rc.text : B.muted,
                    ...
                    {r != null && COMMENT_POOL[skill.id] && (
                      ...
                      >
                        ...
                        {Object.entries(COMMENT_POOL[skill.id]).map(
                          ([lvl, text]) => (
                            <option key={lvl} value={text}>
                              Lv{lvl} – {RATING_LABELS[lvl]}:{' '}
                              {text.slice(0, 50)}…
                            </option>
                          )
                        )}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <button
            onClick={generatePDF}
            disabled={generating || !scriptsReady}
            style={{
              padding: '14px 36px',
              background: generating ? B.muted : B.brown,
              color: B.cream,
              border: 'none',
              borderRadius: 10,
              fontSize: 16,
      ...
      >
        ...
        <ReportPage2
          info={info}
          ratings={ratings}
          proficientGrade={proficientGrade}
          studentLexile={studentLexile}
          notes={notes}
          logo={logo}
        />
      </div>
